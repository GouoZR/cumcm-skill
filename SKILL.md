...
**v1.0**: 基于上游 mathmodel-skill (v6.1.0) 深度定制。专精 CUMCM 国赛，Claude Code 独占；Markdown + DOCX 输出管线替代 LaTeX；集成 Sciverse MCP 真实文献检索，全阶段可溯源引用；支持多 Agent 并行求解/写作/文献查阅；PackyAPI gpt-image-2 概念图 + Python 数据图双轨图表系统。
