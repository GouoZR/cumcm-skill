...
def run_checks(
    ...
    required_paths = (
        ...
        "templates/shared/quality_contract.json",
        "templates/shared/result_registry.json",
        ...
        "references/audit/competition_quality_gates.md",
    ...
    json_paths = [
        ...
        SKILL_ROOT / "templates" / "shared" / "quality_contract.json",
        SKILL_ROOT / "templates" / "shared" / "result_registry.json",
